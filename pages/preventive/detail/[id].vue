<template>
  <div class="animate-fade-in">
    ...
    <DataCard>
      ...
      <div v-if="materialsPending" class="text-center py-4">
...
const { data: materialsData, pending: materialsPending, refresh: refreshMaterials } = useFetch('/api/materials', {
  key: 'materials-detail',
  query: computed(() => ({
    unit: eventData.value?.unit,
    pm: eventData.value?.pm
  })),
  immediate: false
})
...
onMounted(async () => {
  ...
  if (stored) {
    ...
    // Refresh materials after eventData is set
